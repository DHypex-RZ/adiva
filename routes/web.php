...
Route::post("/admin", [AdivaController::class, "asiganarAdminstrador"])->middleware("auth");
Route::post("/expulsar", [AdivaController::class, "expulsarUsuario"])->middleware("auth");
...
Route::delete("/sitios", [Place::class, "eliminarSitio"]);
...
Route::delete("/actividades", [Activity::class, "eliminarActividad"]);
...
Route::delete("/incidentes", [Incident::class, "eliminarIncidente"])->middleware("auth");
...
Route::delete("/google_auth/delete", [GoogleModel::class, "eliminarCuenta"])->middleware("auth");
